    ...
    stops: [
      {
        ...
        detail: "第一天不安排長距離移動。完成取車後直接前往琴平，讓身體慢慢進入四國自駕的節奏。",
        highlights: ["確認 ETC、導航與油種", "高松機場至琴平約 40–50 分鐘", "11 月傍晚較早天黑，不追加遠程景點"],
        note: "實際時間仍要依航班確認。",
        map: mapSearch("高松機場"),
        tags: ["移動", "取車"],
        status: "confirmed"
  ...
  },
  {
    ...
    stops: [
      ...
      },
      {
        ...
        detail: "脇町南町保存了完整的商家町景觀。うだつ防火袖牆、白壁土藏與細長街道，最適合用緩慢步伐觀察。",
        highlights: ["吉田家住宅與白壁街景", "下午三點後屋簷光影佳", "咖啡店與藍染店可視營業彈性停留"],
