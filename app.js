...
status:"confirmed"
  ...
  detail: "弘法大師空海曾在青年時期於室戶一帶修行，而御厨人窟與神明窟，便是相傳距今約1200年前他修行與生活的天然海蝕洞。面向岩窟時，右側的「神明窟」被認為是修行之處，左側的「御厨人窟」則作為生活起居之用。\n相傳空海在此修行開悟時，曾見明星飛來，眼前只有洞外的天空與大海，因此取「空」與「海」二字作為法號。室戶也因此成為弘法大師修行傳說中特別重要的地方。\n弘法大師所開創的四國八十八所遍路，自德島出發，依序經過高知、愛媛與香川。高知縣共有16座札所，被稱為「修行的道場」，而室戶岬正是其中極具象徵性的起點之一。\n御厨人窟前終年可聽見太平洋海浪拍擊岩岸的聲音，其海浪聲也被日本環境省選入「日本聲音風景100選」。",
  highlights: [
    "停留約 20–30 分鐘",
    "與空海修行傳說相關",
    "注意潮濕、落石與現場開放狀況",
  ...
  map: "https://maps.app.goo.gl/JtoFKsysPQMvewPbA",
  tags: ["歷史", "空海", "洞窟", "海岸"],
  status: "confirmed"
},
{
...
},
{
  ...
  weekday: "五",
  place: "東洋町・海陽・美波",
  title: "沿著海岸，從土佐一路走進阿波",
  lodging: "Kanchantei The Tiny House",
  lodgingMap: "https://maps.app.goo.gl/7tU8PCHhbHS3CzvN8",
  lodgingNote: "美波町，Booking",
  stops: [
    {
      time: "08:30",
      title: "うまめの木・早餐退房",
      ...
      detail: "早餐後從「室戸岬の宿 うまめの木」退房。今天沿著四國東南端的太平洋海岸一路前進，從高知縣跨入德島縣，最後直接住到美波町。\n\n如果前一天下午因時間或天候沒有完成室戶岬燈塔、最御崎寺，可以利用早上補看；如果已經完成，就直接出發往東洋町。",
      highlights: [
        "住宿早餐後退房",
        "前一日未完成的最御崎寺／燈塔可早上補看",
        "今天主要沿國道55號移動",
    ...
    },
    {
      ...
      map: "https://maps.app.goo.gl/Pw3URjLPZ5V9PXBa6",
      tags: ["神社", "古樹", "地方文化", "攝影"],
      status: "confirmed"
    },
    {
      ...
      detail: "白濱海岸就在東洋町海岸線上，適合作為今天的中段休息點。天氣好時到海邊看海、拍照，再到旁邊的道の駅東洋町吃午餐與補給。\n\n道の駅販售當地鮮魚、干物、農產品與東洋町特產。午餐以當天漁獲或簡單定食為主，也可以留意東洋町代表性的椪柑相關商品。",
      nearby: [
        {
          name: "➀ 白浜海水浴場",
          note: "白砂與淺藍色海水是東洋町代表性海岸景觀，停留約20分鐘即可。",
          map: "https://maps.app.goo.gl/Xyy5Lay3SjxX74Hy6"
        },
        {
          name: "➁ 道の駅 東洋町",
          note: "可買當地鮮魚、干物、農產與椪柑產品，也是今天午餐與休息的第一順位。",
          map: "https://maps.app.goo.gl/LhvLFzrEjAauDDrx9"
        }
      ],
      highlights: [
        "午餐與休息合併安排",
    ...
    },
    {
      ...
      map: "https://maps.app.goo.gl/MDHziGsmRK5R3dDT7",
      tags: ["寺院", "歷史", "庭園", "文化"],
      status: "confirmed"
    },
    {
      ...
      title: "水床灣・宍喰海岸",
      eyebrow: "午後彈性",
      summary: "如果時間與天候都合適，就在宍喰海岸短暫停下來看看海。",
      detail: "水床灣是宍喰代表性的海岸景觀，海灣中散布著大小島嶼與奇岩。\n如果城滿寺停留較久，或希望早一點抵達美波町，就直接略過；若天氣很好，則停留約20～30分鐘看海、拍照即可。",
      highlights: [
        "完全彈性",
        "以短程散步與拍照為主",
        "建議停留20–30分鐘",
    ...
    {
      time: "17:00",
      title: "入住 Kanchantei The Tiny House",
      eyebrow: "美波町・今晚的家",
      summary: "一路沿太平洋北上，今晚直接住進美波町，讓隔天從日和佐慢慢開始。",
      detail: "從室戶出發，經東洋町、甲浦與海陽町一路北上後，今晚直接住到日和佐所在的美波町，隔天可以直接從大濱海岸、藥王寺與日和佐街區開始一天。\n入住後不再安排遠距離移動，晚餐依住宿附近店家與實際營業狀況決定。",
      highlights: [
        "住宿：Kanchantei The Tiny House",
        "位於美波町",
        "入住後不再長途開車",
        "隔天直接從日和佐開始",
        "晚餐依附近店家彈性安排"
      ],
      map: "https://maps.app.goo.gl/7tU8PCHhbHS3CzvN8",
      tags: ["住宿", "美波町", "日和佐"],
      status: "confirmed"
    }
  ]
  ...
  weekday: "六",
  place: "日和佐・德島",
  title: "海龜之町的清晨，走進阿波城下",
  lodging: "ダイワロイネットホテル徳島駅前",
  lodgingMap: "https://maps.app.goo.gl/KwAriL5gDYcPs5iz8",
  lodgingNote: "11/21、11/22 連住兩晚，含早餐",
  stops: [
    {
      time: "08:30",
      title: "Kanchantei 退房・日和佐散步",
      eyebrow: "美波清晨",
      summary: "從美波町的住宿出發，不必長途開車，直接開始日和佐的海邊小鎮早晨。",
      detail: "早餐與整理行李後離開 Kanchantei The Tiny House。\n上午以大濱海岸、藥王寺與門前町為主，不急著趕往下一站。",
      highlights: [
        "上午完整留給日和佐",
        "行李放車上即可",
        "以海岸、寺院與小鎮散步為主"
    ...
    },
    {
      ...
      title: "大濱海岸",
      eyebrow: "海龜之町",
      summary: "用太平洋海岸開始一天，感受日和佐小鎮與大海之間的距離。",
      detail: "大濱海岸是日和佐最具代表性的自然景觀之一，也是日本知名的海龜產卵地。\n十一月不是海龜產卵季，但清晨海岸本身就很值得散步。",
      highlights: [
        "建議停留約20–30分鐘",
        "適合拍攝太平洋與海岸線",
        "清晨散步為主",
    ...
    },
    {
      ...
      title: "藥王寺（第23番札所）",
      eyebrow: "四國遍路",
      summary: "從朱色石階走上山坡寺院，在清晨看見日和佐與太平洋。",
      detail: "藥王寺是四國八十八箇所第23番札所，也是日和佐最重要的地標。\n\n寺院位於山坡上，從山門、石階到高處的瑜祇塔，都能感受到四國遍路文化與地方信仰。今天比原本提早約一小時抵達，可以用更從容的節奏慢慢走，也有機會避開部分中午前後的人潮。",
      nearby: [
        {
          name: "➀ 日和佐門前町",
          note: "藥王寺山腳周邊的小街，參拜前後都適合慢慢散步。",
          map: "https://maps.app.goo.gl/Q2kb4SRSRrLMREF98"
        },
        {
          name: "➁ at Teramae",
          note: "藥王寺附近的咖啡店，可視營業時間作為參拜後休息。",
    ...
    },
    {
      ...
      title: "日和佐門前町・咖啡散步",
      eyebrow: "小鎮時間",
      summary: "從藥王寺下山後，不急著開車離開，在門前町留一點真正屬於日和佐的時間。",
      detail: "從藥王寺下山後，可以沿門前町與日和佐街區慢慢走一段。\n如果看到喜歡的小店、咖啡店或街景，就停下來；如果想早點吃午餐，也可以直接往下一張卡。",
      nearby: [
        {
          name: "➀ at Teramae",
          note: "如果當天有營業，可以作為藥王寺參拜後短暫喝咖啡的候選。",
          map: "https://maps.app.goo.gl/s2k15EEN5W6XUuvw7"
        }
      ],
      highlights: [
    ...
    },
    {
      ...
      title: "日和佐午餐",
      eyebrow: "地方料理",
      summary: "留在海邊小鎮吃完午餐，再往山間的平等寺前進。",
      detail: "午餐仍然安排在日和佐。今天上午不用趕車程，所以可以比較從容地選一間地方餐廳。\n\n候選方向以當地魚料理、阿波尾雞與定食為主。實際餐廳依營業日與當天狀況調整。",
      restaurants: [
        {
          name: "➀ ひわさ屋",
    ...
    },
    {
      ...
      title: "前往德島市",
      eyebrow: "從海岸到城下町",
      summary: "結束美波與遍路寺院行程，往德島市區前進。",
      detail: "離開平等寺後往德島市前進。今天下午不再增加大型景點，讓入住後的德島市區時間更輕鬆。\n\n住宿位於德島站前，抵達後可以把車停好，接下來以步行探索市區。",
      highlights: [
        "平等寺後直接往德島市",
        "下午不再追加遠程景點",
        "入住後不再開車",
      ...
      map: "https://maps.app.goo.gl/6jixjmgvK9ta83Jq6",
      tags: ["移動", "德島"],
      status: "confirmed"
    },
    {
      ...
      eyebrow: "德島市基地",
      summary: "提早回到城市，連住兩晚，把剩下的下午與晚上交給德島街區。",
      ...
      restaurants: [
        ...
        },
        {
          ...
          note: "2025百名店，可品嘗阿波尾雞、地酒等地方料理。步行16分鐘。"
        }
      ],
      highlights: [
        "11/21、11/22連住兩晚",
    ...
    },
    {
      ...
      title: "德島站前・新町川散步",
      eyebrow: "城市夜晚",
      summary: "不用再完成任何清單，在德島站周邊吃飯、散步，慢慢結束一天。",
      detail: "今晚沒有固定景點。可以依體力選擇德島拉麵、阿波尾雞或居酒屋，再到新町川、商店街一帶短暫散步。\n\n明天還有太龍寺與德島市區行程，所以今晚不用刻意塞進眉山或阿波舞會館。",
      highlights: [
        "晚上不開車",
        "德島站周邊步行即可",
        "晚餐依現場狀況選擇",
...
},
{
  ...
  stops: [
    {
      time: "09:00",
      title: "德島城跡・舊德島城表御殿庭園",
      eyebrow: "蜂須賀氏的城下町",
      summary: "從德島城開始一天，在石垣、庭園與城跡之間認識阿波蜂須賀家的歷史。",
      detail: "德島城是蜂須賀氏治理阿波國的重要據點。1585年，蜂須賀家政進入阿波後築城，此後德島城長期作為阿波藩政治中心。\n\n今天雖然天守與主要建築已不復存在，但仍可沿著石垣、堀跡與德島中央公園感受昔日城郭格局。園內的舊德島城表御殿庭園，是江戶時代大名庭園的重要遺構，以枯山水與池泉回遊式庭園構成。\n\n上午不需要趕路，從鷲之門、石垣一路走進庭園。如果對蜂須賀家與德島城歷史有興趣，也可以視時間進入德島城博物館。",
      nearby: [
        {
          name: "➀ 舊德島城表御殿庭園",
          note: "位於德島城跡內，為國指定名勝。與德島城跡一起參觀即可。",
          map: "https://maps.app.goo.gl/PbhgmvcZHwimscP59?g_st=ic"
        },
        {
          name: "➁ 德島城博物館",
          note: "介紹蜂須賀家、德島城與阿波藩歷史。如果早上想深入了解城下町，可以視時間入館。",
          map: "https://maps.app.goo.gl/PWTRCgdbC6foKFtw9?g_st=ic"
        },
        {
          name: "➂ 鷲之門",
          note: "德島城代表性的入口建築，可與城跡散步一起觀看。",
          map: "https://maps.app.goo.gl/da58PLiS8L1Q1Bo48?g_st=ic"
        }
      ],
      highlights: [
        "蜂須賀氏的阿波藩城郭",
    ...
    },
    {
      ...
      title: "前往阿波舞會館",
      eyebrow: "走進德島市中心",
      summary: "離開德島城，往新町橋與眉山方向移動，準備看11點的阿波舞公演。",
      detail: "從德島城一帶前往阿波舞會館。今天上午最重要的固定時間是11:00的白天阿波舞公演，因此德島城參觀時間不要拖得太晚。\n\n如果車子可以繼續停在飯店或市中心合適的位置，這一段可以依當天狀況選擇步行或短程移動。",
      highlights: [
        "以11:00阿波舞公演為固定時間",
        "建議10:45左右抵達阿波舞會館",
        "先確認表演場次與售票狀況"
      ],
      map: "https://maps.app.goo.gl/h5sqpbShgvYjP63o6?g_st=ic",
      tags: ["移動", "德島市"],
      status: "confirmed"
    },
    {
      ...
      title: "阿波舞會館・白天公演",
      eyebrow: "德島代表文化",
      summary: "不用等到夏季祭典，在劇場裡近距離看阿波舞的節奏、舞步與樂器。",
      detail: "阿波舞是德島最具代表性的地方文化之一。每年夏季的阿波舞祭典讓整座城市化為舞台，但即使不是祭典期間，也可以在阿波舞會館欣賞正式公演。\n白天公演可以近距離看到男舞、女舞以及三味線、笛、鉦與太鼓等囃子演奏，也更容易理解阿波舞看似自由、其實有著明確節奏與舞步差異的特色。\n比起只在展覽中閱讀歷史，實際看一場演出會更容易記住德島的城市性格。",
      highlights: [
        "安排11:00白天公演",
        "公演約40分鐘",
        "觀察男舞與女舞的不同",
      ...
      map: "https://maps.app.goo.gl/iNTdLke99DP9CGGWA",
      tags: ["阿波舞", "表演", "地方文化", "德島"],
      status: "confirmed"
    },
    {
      ...
      title: "德島市區・午餐",
      eyebrow: "阿波的味道",
      summary: "表演結束後留在市中心吃午餐，德島拉麵、阿波尾雞或地方定食都可以。",
      detail: "午餐不綁死單一餐廳，依當天排隊、營業狀況與想吃的料理決定。\n\n下午還需要開車前往藍住町，因此午餐以德島市中心、阿波舞會館或德島站周邊為主，不需要為了特定餐廳繞路。",
      restaurants: [
        {
          name: "➤ tabelog 德島車站",
          map: "https://tabelog.com/tw/tokushima/A3601/A360101/R6692/rstLst/?SrtT=rt",
        ...
        },
        {
          name: "➀ 德島拉麵",
          map: mapSearch("徳島駅 徳島ラーメン"),
          note: "德島代表性地方料理之一，依排隊與營業狀況現場選擇。"
        },
        {
          name: "➁ 阿波尾雞料理",
          map: mapSearch("徳島駅 阿波尾鶏 ランチ"),
          note: "如果不想吃拉麵，可以找阿波尾雞定食或料理。"
        }
      ],
      highlights: [
        "午餐預留約1小時",
    ...
    },
    {
      ...
      title: "前往藍住町",
      eyebrow: "從城下町到阿波藍",
      summary: "離開德島市中心，開車前往昔日因阿波藍而繁榮的藍住町。",
      detail: "午餐後取車前往藍住町。下午不再安排寺院，而是把時間留給德島另一項重要文化——阿波藍。\n\n藍住町一帶昔日與藍的栽培、製作及交易關係密切，接下來參觀的藍の館就是由昔日大藍商奧村家的宅邸保存而成。",
      highlights: [
        "午餐後再取車",
        "德島市往藍住町約短程移動",
        "下午主角為阿波藍文化",
    ...
    },
    {
      ...
      title: "藍の館・阿波藍染體驗",
      eyebrow: "阿波藍商的宅邸",
      summary: "走進昔日大藍商住宅，從一株蓼藍開始認識曾讓德島繁榮的「阿波藍」。",
      detail: "藍の館利用昔日大藍商奧村家的宅邸改建而成，保存阿波藍的栽培、製作、流通與染色文化。\n\n吉野川流域肥沃的土地適合種植蓼藍，自江戶時代起，阿波便成為日本最重要的藍產地之一。藍不只是染布工藝，也曾經是支撐德島商業與地方財富的重要產業。\n\n館內除了可以看到傳統製藍工具、藍商住宅與生活空間，也可以親手進行藍染體驗。這次很推薦至少染一條手帕，體驗時間約30分鐘，完成後也能成為這趟德島旅行最有地方特色的紀念品之一。",
      highlights: [
        "舊奧村家藍商宅邸",
        "認識蓼藍、蒅與傳統藍染",
        "了解阿波藍曾經帶來的商業繁榮",
      ...
      note: "藍染體驗受理時間與費用出發前再次確認；如果當天不想染，也可以單純參觀宅邸與展示。",
      map: mapSearch("藍の館 徳島"),
      tags: ["阿波藍", "歷史建築", "藍染", "文化體驗"],
      status: "confirmed"
    },
    {
      time: "14:45",
      title: "返回德島市",
      eyebrow: "午後回城",
      summary: "結束藍染後回到德島市，把最後的午後留給眉山與夕暮。",
      detail: "離開藍の館後直接返回德島市，不再追加其他遠距離景點。\n\n回到阿波舞會館一帶後，如果時間比預計早，可以逛伴手禮、喝咖啡或在新町橋附近短暫休息。接下來的眉山以天候為優先，不需要趕行程。",
      highlights: [
        "藍の館後直接回德島",
        "不再追加其他景點",
        "有空檔可喝咖啡或逛伴手禮",
    ...
    },
    {
      ...
      title: "眉山纜車・眉山山頂",
      eyebrow: "秋日夕暮",
      summary: "搭纜車登上德島市的象徵，在天色轉暗前俯瞰吉野川與整座城市。",
      detail: "眉山因從不同方向觀看都像眉毛而得名，是德島市最具代表性的山。\n\n從阿波舞會館樓上搭乘纜車，只需數分鐘便可抵達山頂。天氣晴朗時，可以俯瞰德島市區、吉野川與紀伊水道，視野良好時甚至能遠望淡路島與紀伊半島。\n\n十一月下旬日落較早，因此刻意把眉山留到下午最後。若天候配合，可以從白天一路看到夕暮與城市逐漸亮燈的變化。\n\n但這一站完全以天氣為準。如果當天下雨、雲霧很厚或山頂沒有視野，就直接取消，不需要為完成行程硬上山。",
      highlights: [
        "從阿波舞會館直接搭眉山纜車",
        "纜車單程約數分鐘",
        "俯瞰德島市與吉野川",
      ...
      note: "11月纜車營業時間較夏季短，出發前再次確認2026年11月22日的營運時間與天候。",
      map: mapSearch("眉山ロープウェイ"),
      tags: ["眉山", "纜車", "展望", "夕景"],
      status: "flex"
    },
    {
      ...
      title: "新町川・東新町散步",
      eyebrow: "城市黃昏",
      summary: "從眉山回到街上，不再趕景點，沿著新町川與商店街慢慢走回德島的夜晚。",
      detail: "下山後已經不安排正式景點。可以沿新町橋、新町川與東新町商店街一帶散步，看看德島市中心從黃昏進入夜晚的樣子。\n\n如果當天眉山因天候取消，這一段就可以提前開始，找間咖啡店、逛商店街或直接回飯店休息。",
      nearby: [
        {
          name: "➀ 新町橋",
          note: "阿波舞會館前的重要城市節點，適合傍晚沿河散步。",
          map: mapSearch("新町橋 徳島")
        },
        {
          name: "➁ 東新町商店街",
          note: "德島市中心商店街，晚上可依營業狀況隨意逛逛。",
          map: mapSearch("東新町商店街 徳島")
        }
      ],
      highlights: [
        "沒有一定要完成的景點",
    ...
    },
    {
      ...
      title: "德島站前・晚餐",
      eyebrow: "德島最後一夜",
      summary: "回到住宿附近吃晚餐，今晚不再開車，慢慢結束完整的阿波文化日。",
      detail: "今晚是德島市最後一晚，也不需要再完成任何景點。\n\n可以依前一晚吃過的料理做選擇。如果11/21已經吃德島拉麵，今晚可以改吃阿波尾雞、海鮮或居酒屋；反過來也可以把還沒有吃到的德島拉麵留到今晚。\n\n晚餐後步行回ダイワロイネットホテル徳島駅前，整理隔天行李。11/23早上將退房前往鳴門，11:00 Wonder Naruto是隔天最重要的固定行程。",
      restaurants: [
        {
          name: "➀ 德島拉麵候選",
          map: mapSearch("徳島駅 徳島ラーメン"),
          note: "如果前一晚還沒吃到德島拉麵，今晚可以補上。"
        },
        {
          name: "➁ 阿波尾雞・居酒屋",
          map: mapSearch("徳島駅 居酒屋 阿波尾鶏"),
          note: "適合最後一晚吃阿波尾雞與德島地方料理。"
        },
        {
          name: "➂ 德島站周邊餐廳",
          map: mapSearch("徳島駅 レストラン"),
          note: "依當天體力、排隊與營業狀況自由決定。"
        }
      ],
      highlights: [
        "晚上不開車",
