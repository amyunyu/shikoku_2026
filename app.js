...
},
{
  ...
  stops: [
    ...
    },
    {
      ...
      detail: "午餐後不再追加野島斷層、花さじき等淡路島景點，正式開始回香川。\n\n今天的目標是下午約14:00抵達丸龜，因此中途以必要休息為主，不安排額外景點。",
      highlights: [
        "不追加其他淡路島景點",
        "經大鳴門橋返回四國",
        "直接往丸龜",
    ...
    },
    {
      ...
      detail: "丸龜城是今天下午最重要的一站。它不只是看天守，更重要的是整座龜山城郭與極具代表性的高石垣。\n\n從大手門進城後，可以沿見返り坂慢慢上山，途中觀看石垣曲線與城下視野，再進入現存天守。\n\n官方目前天守開放時間為09:00～16:30，最晚16:00入城。因此14:00左右抵達，可以比較從容地走上去，不需要為了趕最後入場而加快腳步。",
      nearby: [
        {
          name: "➀ 大手一の門・大手二の門",
          note: "從城下進入丸龜城的主要入口，適合從這裡開始完整感受城郭。",
          map: mapSearch("丸亀城 大手一の門")
        },
        {
          name: "➁ 見返り坂",
          note: "前往本丸的重要坡道。坡度明顯，但沿途能看到丸龜城最具代表性的高石垣。",
          map: mapSearch("丸亀城 見返り坂")
        },
        {
          name: "➂ 丸龜城天守",
          note: "現存十二天守之一。規模不大，但木造空間與城下視野非常有歷史感。",
          map: mapSearch("丸亀城 天守")
        }
      ],
      highlights: [
        "現存十二天守之一",
    ...
    },
    {
      ...
      restaurants: [
        {
          name: "骨付鳥",
          note: "香川代表性料理。餐廳之後再依實際營業日與位置補入。",
          map: mapSearch("骨付鳥 高松 瓦町")
        }
      ],
      highlights: [
        "步行活動",
